...
class SubscriptionContractUpdateJob implements ShouldQueue
{
    ...
    public function handle(SubscriptionContractStream $subscriptionContractStream): void
    {
        ...
        Log::info('Subscription contract update webhook job started.', [
        ...
        Log::info('Subscription contract update webhook job broadcasting event.', [
            'shopDomain' => $shopDomain,
            'contractId' => $contractId,
        ]);

        event(new ContractCreated($shopDomain, $contractId, 'subscription_contracts/update'));
    }
